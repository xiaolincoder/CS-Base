...
![接收到历史数据的异常](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/TCP-参数/31.jpg)
...
![没有确保正常断开的异常](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/TCP-参数/32.jpg)
