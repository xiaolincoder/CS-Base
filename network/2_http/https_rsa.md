...
![](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost4@main/网络/https/https提纲.png)
...
![](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/HTTP/19-HTTPS与HTTP.png)
...
![](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost4@main/网络/https/tls握手.png)
...
![](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost4@main/网络/https/tls四次握手.png)

对应 Wireshark 的抓包，我也画了一幅图，你可以从下图很清晰地看到该过程：

![](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost4@main/网络/https/https_rsa.png)
...
![](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost4@main/网络/https/clienthello.png)
...
![](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost4@main/网络/https/serverhello.png)
...
![](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost4@main/网络/https/certificate.png)


随后，服务端发了「**Server Hello Done**」消息，目的是告诉客户端，我已经把该给你的东西都给你了，本次打招呼完毕。

![](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost4@main/网络/https/serverhellodone.png)
...
![](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost4@main/网络/https/证书的校验.png)
...
![](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost4@main/网络/https/baidu证书.png)
...
![](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost4@main/网络/https/用户信任.png)


操作系统里一般都会内置一些根证书，比如我的 MAC 电脑里内置的根证书有这么多：

![](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost4@main/网络/https/系统根证书.png)

这样的一层层地验证就构成了一条信任链路，整个证书信任链验证流程如下图所示：

![](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost4@main/网络/https/证书链.png)
...
![](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost4@main/网络/https/clietnkeyexchange.png)
