...
![用户空间与内存空间](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/%E6%93%8D%E4%BD%9C%E7%B3%BB%E7%BB%9F/%E5%86%85%E5%AD%98%E7%AE%A1%E7%90%86/20-%E5%86%85%E6%A0%B8%E7%A9%BA%E9%97%B4%E5%92%8C%E7%94%A8%E6%88%B7%E7%A9%BA%E9%97%B4.jpg)
...
![每个进程的内核空间都是一致的](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/%E6%93%8D%E4%BD%9C%E7%B3%BB%E7%BB%9F/%E5%86%85%E5%AD%98%E7%AE%A1%E7%90%86/21-%E5%A4%9A%E4%B8%AA%E8%BF%9B%E7%A8%8B%E5%85%B1%E4%BA%AB%E5%86%85%E6%A0%B8%E7%A9%BA%E9%97%B4.jpg)
...
我们可以通过 /proc/<pid>/maps 文件查看进程的内存分布情况。我在 maps 文件通过此 1 字节的内存起始地址过滤出了内存地址的范围。
...
![image-20220318201542652](/Users/xiaolin/Library/Application Support/typora-user-images/image-20220318201542652.png)

从下图可以看到，通过 free 释放内存后，堆内存还是存在的，并没有归还给操作系统。

![image-20220318201552680](/Users/xiaolin/Library/Application Support/typora-user-images/image-20220318201552680.png)
...
![image-20220318203457165](/Users/xiaolin/Library/Application Support/typora-user-images/image-20220318203457165.png)

查看进程的内存的分布情况，可以发现最右边没有 [head] 标志，说明是通过 mmap 以匿名映射的方式从文件映射区分配的匿名内存。

![image-20220318203543938](/Users/xiaolin/Library/Application Support/typora-user-images/image-20220318203543938.png)

然后我们释放掉这个内存看看：

![image-20220318204000283](/Users/xiaolin/Library/Application Support/typora-user-images/image-20220318204000283.png)

再次查看该 128 KB 内存的起始地址，可以发现已经不存在了，说明归还给了操作系统。

![image-20220318204010836](/Users/xiaolin/Library/Application Support/typora-user-images/image-20220318204010836.png)

对于 「malloc 申请的内存，free 释放内存会归还给操作系统吗？」这个畏难而退，我们可以做个总结了：
...
写的比较仓促。后面会继续完善下，关于 malloc 是如何对内存进行管理的，我们下次聊。
